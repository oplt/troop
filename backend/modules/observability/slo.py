...
SLO_DEFINITIONS: tuple[ServiceLevelObjective, ...] = (
    ...
    ServiceLevelObjective(
        ...
        owner="platform",
        severity="ticket",
        indicator="Simple HTTP read p95 <= 250ms",
        runbook="docs/operations/LATENCY_SLOS.md#simple-api-reads",
    ),
    ServiceLevelObjective(
        name="project_detail_p95_latency",
        target=0.95,
        window="30d",
        owner="orchestration",
        severity="ticket",
        indicator="Project detail read p95 <= 500ms",
        runbook="docs/operations/LATENCY_SLOS.md#project-detail",
    ),
    ServiceLevelObjective(
        name="vector_retrieval_p95_latency",
        target=0.95,
        window="30d",
        owner="ai-platform",
        severity="ticket",
        indicator="Vector search p95 <= 500ms excluding embedding",
        runbook="docs/operations/LATENCY_SLOS.md#vector-retrieval",
    ),
    ServiceLevelObjective(
        name="run_success",
        target=0.95,
