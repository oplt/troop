...
class OrchestrationProjectsServiceMixin:
    ...
    async def execution_insights(self, user: User, days: int = 7) -> dict[str, Any]:
        ...
        for run_id, event_rows in events_by_run.items():
            for event_type, _payload in event_rows:
        ...
        def new_rollup(identifier: str | None, name: str) -> dict[str, Any]:
            return {
                "id": identifier,
                "name": name,
                "runs": 0,
        ...
        def add_run(row: dict[str, Any], run: Any, run_id: str) -> None:
            row["runs"] += 1
        ...
        def finalize_rollups(items: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        return {
            ...
            "by_task": finalize_rollups(by_task),
            "by_provider": finalize_rollups(by_provider),
        }
